...
- set_tab_volume: mute, unmute, or turn the volume of the current tab up or down.
...
export const TOOLS = [
  ...
  },
  {
    ...
    function: {
      name: "set_tab_volume",
      description: "Control audio of the current tab only (not system volume).",
      parameters: {
        type: "object",
        properties: { action: { type: "string", enum: ["mute", "unmute", "up", "down"] } },
        required: ["action"],
      },
    },
  },
